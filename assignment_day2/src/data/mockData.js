export const movies = [
  {
    ...
    language: 'English',
    description:
      'A daring pilot uncovers a signal that could change the fate of humanity.',
    tag: 'Now Showing',
  ...
  },
  {
    ...
    language: 'Hindi',
    description:
      'A gifted composer redefines her future during the city lights festival.',
    tag: 'Trending',
  ...
  },
  {
    ...
    language: 'English',
    description:
      'A cyber investigator chases a conspiracy hidden in plain sight.',
    tag: 'Recommended',
